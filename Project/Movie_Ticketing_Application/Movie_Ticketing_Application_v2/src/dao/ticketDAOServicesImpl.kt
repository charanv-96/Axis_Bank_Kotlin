...
object ticketDAOServicesImpl : ticketDAOServices
{
    override fun insertTicket(USER_ID: Int, MOVIE_ID: Int, NO_OF_TICKETS: Int, COST: Double):Boolean
    {
    ...
    override fun checkTable(tId : Int) : Boolean
    {
    ...
    override fun deleteTicket(tId: Int)
    {
        val conn = getConnection1()
    ...
    override fun viewTicket(tId: Int)
    {
        val sql = "SELECT * FROM TICKETS WHERE TICKET_ID = '$tId'"
        val conn = getConnection1()
        val statement: Statement = conn!!.createStatement()
    ...
    override fun printTicket(tId : Int)
    {
        val sql = "SELECT * FROM TICKETS WHERE TICKET_ID = '$tId'"
        val conn = getConnection1()
        val statement: Statement = conn!!.createStatement()
